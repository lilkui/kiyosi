...
- Represent each risk measure as one `optional` slot indexed by a contiguous risk-measure enumeration. Remove the result availability bitmask and NaN sentinel.
