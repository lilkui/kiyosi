...
void bind_basic_preset(nb::module_& module, const char* name, Factory factory)
{
    module.def(
        name,
        [factory](nb::handle coupon_rate, nb::handle initial_price,
                  nb::handle knock_in_price, nb::handle knock_out_price,
                  nb::handle observations, nb::handle effective, nb::handle expiry,
                  barrier_touch_status touch_status, nb::handle principal_ratio) {
...
void bind_presets(nb::module_& module)
{
    ...
    module.def(
        "step_down_snowball",
        [](nb::handle coupon_rate, nb::handle initial_price, nb::handle knock_in_price,
           nb::handle knock_out_start, nb::handle knock_out_step, nb::handle observations,
           nb::handle effective, nb::handle expiry, barrier_touch_status touch_status,
           nb::handle principal_ratio) {
    ...
    module.def(
        "both_down_snowball",
        [](nb::handle coupon_start, nb::handle coupon_step, nb::handle initial_price,
           nb::handle knock_in_price, nb::handle knock_out_start, nb::handle knock_out_step,
           nb::handle observations, nb::handle effective, nb::handle expiry,
           barrier_touch_status touch_status, nb::handle principal_ratio) {
    ...
    module.def(
        ...
        [](nb::handle knock_out_coupon, nb::handle maturity_coupon,
           nb::handle initial_price, nb::handle knock_in_price, nb::handle knock_out_price,
           nb::handle observations, nb::handle effective, nb::handle expiry,
           barrier_touch_status touch_status, nb::handle principal_ratio) {
    ...
    module.def(
        "parachute_snowball",
        [](nb::handle coupon_rate, nb::handle initial_price, nb::handle knock_in_price,
           nb::handle knock_out_price, nb::handle final_knock_out_price,
           nb::handle observations, nb::handle effective, nb::handle expiry,
           barrier_touch_status touch_status, nb::handle principal_ratio) {
    ...
    module.def(
        "otm_snowball",
        [](nb::handle coupon_rate, nb::handle initial_price, nb::handle knock_in_price,
           nb::handle knock_out_price, nb::handle upper_strike, nb::handle observations,
           nb::handle effective, nb::handle expiry, barrier_touch_status touch_status,
           nb::handle principal_ratio) {
    ...
    module.def(
        ...
        [](nb::handle coupon_rate, nb::handle initial_price, nb::handle knock_in_price,
           nb::handle knock_out_price, nb::handle lower_strike, nb::handle observations,
           nb::handle effective, nb::handle expiry, barrier_touch_status touch_status,
           nb::handle principal_ratio) {
...
void bind_structured_instruments(nb::module_& module)
{
    auto snowball = nb::class_<SnowballOption>(module, "SnowballOption")
        .def(nb::new_([](nb::handle knock_out_coupon_rates, nb::handle maturity_coupon_rate,
                        nb::handle initial_price, nb::handle knock_in_price,
                        nb::handle knock_out_prices, nb::handle upper_strike,
                        nb::handle lower_strike, nb::handle observations,
                        observation_frequency frequency, barrier_touch_status touch_status,
                        nb::handle principal_ratio, nb::handle effective, nb::handle expiry) {
        ...
        .def("with_coupon_rate", [](const SnowballOption& option, nb::handle coupon) {
    ...
    auto binary = nb::class_<BinarySnowballOption>(module, "BinarySnowballOption")
        .def(nb::new_([](nb::handle knock_out_coupon_rates, nb::handle maturity_coupon_rate,
                        nb::handle initial_price, nb::handle knock_out_prices,
                        nb::handle upper_strike, nb::handle lower_strike,
                        nb::handle observations, barrier_touch_status touch_status,
                        nb::handle principal_ratio, nb::handle effective, nb::handle expiry) {
    ...
    auto ternary = nb::class_<TernarySnowballOption>(module, "TernarySnowballOption")
        .def(nb::new_([](nb::handle knock_out_coupon_rates, nb::handle maturity_coupon_rate,
                        nb::handle minimal_coupon_rate, nb::handle initial_price,
                        nb::handle knock_in_price, nb::handle knock_out_prices,
                        nb::handle upper_strike, nb::handle lower_strike,
                        nb::handle observations, observation_frequency frequency,
                        barrier_touch_status touch_status, nb::handle principal_ratio,
    ...
    auto phoenix = nb::class_<PhoenixOption>(module, "PhoenixOption")
        .def(nb::new_([](nb::handle coupon_rate, nb::handle initial_price,
                        nb::handle knock_in_price, nb::handle knock_out_prices,
                        nb::handle coupon_barriers, nb::handle upper_strike,
                        nb::handle lower_strike, nb::handle observations,
                        observation_frequency frequency, barrier_touch_status touch_status,
                        nb::handle principal_ratio, nb::handle effective, nb::handle expiry) {
        ...
        .def("with_coupon_rate", [](const PhoenixOption& option, nb::handle coupon) {
            return unwrap(option.with_coupon_rate(real_number(coupon, "coupon")));
        }, "coupon"_a);
